...
if [ "$compileFlag" = true ]; then
   ...
   for b in ${benchmarks[@]}; do
      ...
      echo "#This script was generated by Speckle capstone-o3-emu.sh" >> ${run_script}
...
if [ "$genCommandsFlag" = true ]; then
   ...
   cd $SPEC_DIR; . ./shrc; time runcpu --config=capstone-o3-emu.cfg --fake --verbose 9  --size ${input_type} --action=onlyrun ${suite_type} > $log_file
