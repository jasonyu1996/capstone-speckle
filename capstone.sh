...
if [ "$compileFlag" = true ]; then
   ...
   for b in ${benchmarks[@]}; do
      ...
      run_script=${output_dir}/run_capstone.sh
      echo "#!/bin/bash" > ${run_script}
      echo "#This script was generated by Speckle capstone.sh" >> ${run_script}
      ...
      for input in "${commands[@]}"; do
         if [[ ${input:0:1} != '#' ]]; then # allow us to comment out lines in the cmd files
            ...
            workload_run_script=${output_dir}/run_capstone_workload${workload_idx}.sh
            echo "#!/bin/bash" > ${workload_run_script}
            cmd="run_workload ./$(basename "${target_bin}") ${input}"
